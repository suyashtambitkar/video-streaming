            ...
            <div className="border border-[#4e4e53] w-full mx-8 md:w-1/2 lg:w-1/4 px-6 py-4 md:px-9 md:py-6 mt-12">
                ...
                >
                    ...
                    <div className="w-full mb-4">
                        ...
                        <button  type="button" onClick={() => { selectImgRef.current.click() }} className={`flex items-center justify-center gap-2 border ${selectImg ? "border-[#6bb676]" : "border-[#4e4e53]"} text-xs w-full bg-black text-[#9c9da1] px-2 py-2`}>Select Image<FiUpload /></button>
                    ...
                    <div className="mb-5">
                        <button type="submit" className="w-full py-1  bg-[#4a57bf] hover:bg-[#3f4ebe]">{uploading ? "Logging..." : "Submit"}</button>
                    </div>
                </form>
